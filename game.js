...
function create() {
    ...
    batter = this.physics.add.sprite(350, 310, 'batter').setScale(1.8).setOrigin(0.5, 1);
    pitcher = this.physics.add.sprite(400, 300, 'pitcher').setScale(1.8).setOrigin(0.5, 1);
